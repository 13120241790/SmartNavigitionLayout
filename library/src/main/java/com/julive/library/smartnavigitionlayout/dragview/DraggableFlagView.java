...
public class DraggableFlagView extends TextView {
    ...
    private void init() {
        ...
        getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                if (!initBgFlag) {
                    DraggableFlagView.this.setBackgroundDrawable(createStateListDrawable());
                    initBgFlag = true;
                    return false;
                }
                return true;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (!draggable || (root == null || !(root instanceof ViewGroup))) {
            return false;
        }
        ...
        public void cancel() {
            ...
            set.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    DraggableFlagView.this.setVisibility(View.VISIBLE);
                }
            });
            set.start();
    ...
    private StateListDrawable createStateListDrawable() {
        ...
        gradientStateNormal.setColor(backgroundColor);
